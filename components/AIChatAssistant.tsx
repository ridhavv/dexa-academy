...
export const AIChatAssistant: React.FC = () => {
  ...
  const [messages, setMessages] = useState<{role: 'user' | 'bot', text: string}[]>([
    {role: 'bot', text: "Namaste! I'm Dexa. How can I help you today? Are you interested in Basic Money Skills, AI & Python, Communication, or Graphic Design courses for your child?"}
  ]);
